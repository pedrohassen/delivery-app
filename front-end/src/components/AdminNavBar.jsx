  ...
  return (
    <div
      className={ `flex flex-col md:flex-row items-center
        justify-between bg-corHeader text-white` }
    >
      ...
      justify-between max-w-7xl mx-auto px-4 sm:px-6` }
      >
        <ul className="nav-list-left">
          <li
            className={ `ml-4 md:ml-24 xl:ml-40 space-x-4 
      ...
      <nav className="navbar-right pb-4 md:pb-0">
        <ul className="ml-4 flex items-center md:ml-6 font-glacial-bold text-lg">
          <li
            className={ `font-glacial-bold text-lg 
          hover:text-corBotao mx-4 cursor-pointer` }
